      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 items-center min-h-[70vh]">
          <div>
            ...
            >
              <a href="/calcolatore" className="inline-flex items-center justify-center rounded-full bg-[#1663FF] hover:brightness-110 text-white px-6 py-3 font-medium transition">Calcola il tuo preventivo</a>
